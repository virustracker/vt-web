...
function virustracker_register_settings()
{
    ...
    add_settings_field('virustracker_plugin_setting_form_page', 'Form Page ID', 'virustracker_plugin_setting_form_page', 'virustracker_plugin', 'api_settings');
    add_settings_field('virustracker_plugin_setting_submit_page', 'Submit Page ID to send the form to', 'virustracker_plugin_setting_submit_page', 'virustracker_plugin', 'api_settings');
...
function virustracker_plugin_options_validate($input)
{
    ...
    $newinput['form_page']   = $input['form_page'];
 ...
 */
function virustracker_plugin_setting_form_page()
{
    $options = get_option('virustracker_plugin_options');
    
    echo "<input size='300' id='virustracker_setting_form_page' name='virustracker_plugin_options[form_page]' type='text' value='" . $options['form_page'] . "' />";
}
/**
